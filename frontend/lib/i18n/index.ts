...
export interface I18nBundle {
  ...
  REPORT_TYPE_LABELS: typeof ar.REPORT_TYPE_LABELS;
  ENGAGEMENT_TYPE_LABELS: typeof ar.ENGAGEMENT_TYPE_LABELS;
...
export function getMessages(): I18nBundle {
  ...
  return {
    ...
    REPORT_TYPE_LABELS: src.REPORT_TYPE_LABELS,
    ENGAGEMENT_TYPE_LABELS: src.ENGAGEMENT_TYPE_LABELS,
...
export const REPORT_TYPE_LABELS = liveDict(() => source().REPORT_TYPE_LABELS);
export const ENGAGEMENT_TYPE_LABELS = liveDict(() => source().ENGAGEMENT_TYPE_LABELS);
